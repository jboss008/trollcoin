...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // TrollCoin: 0.35 days
static const int64 nTargetSpacing = 300; // TrollCoin: 15 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7aa487b5ef140b7828ed236b9d74a9997c8f5b4d1ffeaf73a623353f40ccd080");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "1389007169 timestamp";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389007169;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 386430478;
        ...
        assert(block.hashMerkleRoot == uint256("0xc30bd31cdd9717e51f68ab1fb347b58d131874dbbab1af66b70bb044476033a5"));
