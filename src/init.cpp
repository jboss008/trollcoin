...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to TrollCoin server / RPC client
            std::string strUsage = _("TrollCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  trollcoin [options]                     " + "\n" +
                  "  trollcoin [options] <command> [params]  " + _("Send command to -server or trollcoin") + "\n" +
                  "  trollcoin [options] help                " + _("List commands") + "\n" +
                  "  trollcoin [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: trollcoin.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 11110 or testnet: 19030)") + "\n" +
